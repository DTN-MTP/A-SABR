...
mod tests {
    ...
    fn test_a_to_c_tree() {
        ...
        let mut algo_sabr = HybridParentingTreeExcl::<NoManagement, EVLManager, SABR>::new(mg.clone());
    ...
    fn test_a_to_c_path_excl() {
        ...
        let mut algo_hop = HybridParentingPathExcl::<NoManagement, EVLManager, Hop>::new(mg.clone());
        let mut algo_sabr = HybridParentingPathExcl::<NoManagement, EVLManager, SABR>::new(mg.clone());
