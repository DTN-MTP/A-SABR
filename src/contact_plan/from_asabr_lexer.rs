use crate::{
    ...
    types::{NodeID, NodeName, VirtualNodeMap},
...
impl ASABRContactPlan {
    ...
    /// * `vnode_map` - A mutable reference to a VirtualNodeMap HashMap, where the new vid and rids will be stored.
